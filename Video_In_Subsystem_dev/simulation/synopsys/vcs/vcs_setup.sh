...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/Video_In_Subsystem_dev_Video_In_Scaler.v \
  $QSYS_SIMDIR/submodules/Video_In_Subsystem_dev_Video_In_RGB_Resampler.v \
  ...
  $QSYS_SIMDIR/submodules/Video_In_Subsystem_dev_Video_In_DMA.v \
  ...
  $QSYS_SIMDIR/submodules/Video_In_Subsystem_dev_Video_In_Clipper.v \
  $QSYS_SIMDIR/submodules/Video_In_Subsystem_dev_Video_In_Chroma_Resampler.v \
  $QSYS_SIMDIR/submodules/altera_up_YCrCb_to_RGB_converter.v \
  $QSYS_SIMDIR/submodules/altera_up_RGB_to_YCrCb_converter.v \
  $QSYS_SIMDIR/submodules/Video_In_Subsystem_dev_Video_In_CSC.v \
  ...
  $QSYS_SIMDIR/submodules/Video_In_Subsystem_dev_Video_In.v \
  $QSYS_SIMDIR/Video_In_Subsystem_dev.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
